...
public class AddCompus extends JFrame{
    ...
    public AddCompus(){
        setTitle("Add Produs Compus Window");
        setSize(550,600);
        ...
        final ProdusCompus auxiliarFinal = new ProdusCompus(" ", 0, 0);
        	...
        	JLabel l1_2 = new JLabel("ADAUGA PRODUS COMPUS: ");
            titlePanel.add(l1_2);
        ...
        ADDButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent startAdd) {
            	...
            	System.out.println(tf1.getText() +  " a fost adaugat ca produs compus in meniu.");
        ...
        JButton ADDButtonIngred = new JButton("Adauga Ingrediente");
        ...
        ADDButtonIngred.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent startAddIngred) {
            	...
            	System.out.println(tf1IN.getText() +  " a fost adaugat un ingredient in produs.");
