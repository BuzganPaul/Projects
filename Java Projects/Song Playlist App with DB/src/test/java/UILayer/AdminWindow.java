		...
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e1)
		    {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							ViewWindow window = new ViewWindow("Song");
		...
		btnNewButton_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e1)
		    {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							control.updateSong(comboBox_3.getSelectedItem().toString(), txtTitle.getText(), txtArtist.getText(), txtGenre.getText(), Integer.parseInt(txtNumberofviews.getText()));
							model.updateViews();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e1)
		    {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							ViewWindow window = new ViewWindow("Regular");
							window.frmViewWindow.setVisible(true);
