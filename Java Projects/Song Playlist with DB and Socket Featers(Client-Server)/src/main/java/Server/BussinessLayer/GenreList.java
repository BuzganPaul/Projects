...
public class GenreList extends SpecificSongList{
	...
	public GenreList(RegularMapper rm, SongMapper sm, PlaylistMapper pm, SongPlaylistMapper em)
	{
		this.rm = rm;
		this.sm = sm;
		this.pm = pm;
