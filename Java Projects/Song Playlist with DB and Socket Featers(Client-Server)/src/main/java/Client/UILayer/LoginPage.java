				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							...
							String type = aux.checking(useraux, passwordaux);
							
							System.out.println("Raspuns:" + type);
							...
							if(type.equals("Error"))
							{
								...
								{
									UserWindow window = new UserWindow(useraux, null);
									window.frmUserWindow.setVisible(true);
								}
								else {
									if(type.equals("Admin"))
									{
										AdminWindow window = new AdminWindow(null);
